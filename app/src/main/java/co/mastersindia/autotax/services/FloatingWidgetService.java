package co.mastersindia.autotax.services;
...
import co.mastersindia.autotax.MainActivity;
...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private void implementClickListeners() {
        ...
        ImageView business=(ImageView)mFloatingWidgetView.findViewById(R.id.popup_business);
        business.setOnClickListener(this);
        ImageView invoice=(ImageView)mFloatingWidgetView.findViewById(R.id.popup_invoice);
        invoice.setOnClickListener(this);
        ImageView items=(ImageView)mFloatingWidgetView.findViewById(R.id.popup_item);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_activity_button:
                ...
                stopSelf();
                break;
            case R.id.popup_business:
                resetPosition(x_init_cord);
                Intent i1 = new Intent(FloatingWidgetService.this, MainActivity.class);
                i1.putExtra("key","business");
            ...
            case R.id.popup_invoice:
                resetPosition(x_init_cord);
                Intent i2 = new Intent(FloatingWidgetService.this, MainActivity.class);
                i2.putExtra("key","invoice");
                ...
                startActivity(i2);
                break;
            case R.id.popup_item:
                resetPosition(x_init_cord);
                Intent i3 = new Intent(FloatingWidgetService.this, MainActivity.class);
                i3.putExtra("key","items");
    ...
    public void onDestroy() {
        ...
        database.putBoolean("popup",false);
